...
<div class="flex flex-col items-center h-full w-full pt-12">
	...
	<h2 class="mt-2 text-center text-3xl font-bold tracking-tight text-base-content">Rekisteröidy</h2>
	<p class="text-center mt-1">
		Tai <a href="/login" class="text-primary font-medium hover:cursor-pointer">kirjaudu</a> jos sinulla
		on jo tili.
	</p>
